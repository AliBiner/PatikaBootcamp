...
1. MyList() : Boş contructor kullanılırsa dizinin başlangıç boyutu 10 olmalıdır.


2. MyList(int capacity) : Dizinin başlangıç değeri capacity parametresinden alınmalıdır.
